...
remap_and_jar "${SOURCE_DIR}riftunmapped.jar" "${TEMP_JAR_LITELOADER}"  
...
cfr "${SOURCE_DIR}riftfci.jar" --outputpath "${SOURCE_DIR}src_rift" --clobber true  
